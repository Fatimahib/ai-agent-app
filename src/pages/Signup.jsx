...
const handleSubmit = async (e) => {
  ...
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden p-4">
      ...
      {/* Signup Card */}
      <div className="relative z-10 w-full max-w-md rounded-3xl bg-white/90 backdrop-blur-lg dark:bg-[#1A1233]/90 p-8 shadow-2xl dark:shadow-[#6E56CF]/10">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-2 gap-4">
            <div className="group relative">
              <input
                ...
                required
                className="w-full rounded-xl border border-gray-300 bg-white/50 px-4 py-3 text-gray-800 focus:border-[#6E56CF] focus:outline-none focus:ring-2 focus:ring-[#6E56CF]/30 dark:border-[#2D1B4D] dark:bg-[#1A1233]/50 dark:text-white"
          ...
          <div className="flex justify-start">
            <Link
              to="/login"
              className="text-sm text-[#6E56CF] hover:text-[#9B8AFF] transition-colors"
            >
